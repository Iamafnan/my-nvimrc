...
_G.packer_plugins = {
  ...
  ["tokyonight.nvim"] = {
    config = { "\27LJ\2\2ç\1\0\0\2\0\3\0\0046\0\0\0005\1\2\0=\1\1\0K\0\1\0\1\0\4 tokyonight_italic_functions\2\31tokyonight_italic_keywords\2 tokyonight_italic_variables\2\21tokyonight_style\nstorm\6g\bvim\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\2ç\1\0\0\2\0\3\0\0046\0\0\0005\1\2\0=\1\1\0K\0\1\0\1\0\4 tokyonight_italic_functions\2\31tokyonight_italic_keywords\2 tokyonight_italic_variables\2\21tokyonight_style\nstorm\6g\bvim\0", "config", "tokyonight.nvim")
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-luapad', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'null-ls.nvim', 'nvim-lightbulb', 'github-notifications.nvim', 'neogit', 'lsp_signature.nvim', 'LuaSnip', 'fidget.nvim', 'lspsaga.nvim', 'nvim-lspconfig', 'octo.nvim', 'nvim-cmp'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'copilot.vim', 'tabout.nvim', 'cmp_luasnip', 'friendly-snippets', 'cmp-buffer', 'abusaidm.html-snippets-0.0.18', 'cmp-nvim-lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
