...
_G.packer_plugins = {
  ...
  LuaSnip = {
    after = { "abusaidm.html-snippets-0.0.18" },
  ...
  ["fidget.nvim"] = {
    config = { "require('afnan.lsp.fidget')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  neogit = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/neogit",
  ...
  ["octo.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/octo.nvim",
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'cmp-nvim-lua', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-cmp', 'fidget.nvim', 'nvim-lspconfig', 'octo.nvim', 'lsp_signature.nvim', 'nvim-lightbulb', 'lspsaga.nvim', 'null-ls.nvim', 'LuaSnip', 'neogit', 'github-notifications.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'copilot.vim', 'abusaidm.html-snippets-0.0.18', 'cmp_luasnip', 'tabout.nvim', 'cmp-nvim-lua', 'cmp-buffer', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
