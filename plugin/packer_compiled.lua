...
_G.packer_plugins = {
  ...
  ["cmp-spell"] = {
    after_files = { "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/cmp-spell/after/plugin/cmp-spell.lua" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/cmp-spell",
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-spell", "cmp-buffer", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-code-action-menu"] = {
    commands = { "CodeActionMenu" },
    config = { "require('afnan.lsp.codeaction')" },
    load_after = {
      ["nvim-lspconfig"] = true
    },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lightbulb", "nvim-code-action-menu" },
  ...
  ["vim-vsnip"] = {
    after = { "vs-snippets", "nodejs-snippets", "cmp-vsnip" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
